...
class DiTModel(nn.Module):
    ...
    def setup(self):
        ...
        # Use language conditioning instead of class conditioning
    ...
    def __call__(self, x: Array, t: Array, y: Optional[Array], rng: PRNGKey, train: bool):
        """
        x: latent or image tensor of shape (B, C, H, W)
        t: timestep tensor of shape (B,)
        y: language embedding tensor of shape (B, C, N)
        """
