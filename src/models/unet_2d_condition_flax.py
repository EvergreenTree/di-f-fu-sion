...
class FlaxUNet2DConditionModel(nn.Module, FlaxModelMixin, ConfigMixin):
    ...
    def init_weights(self, rng: jax.Array) -> FrozenDict:
        ...
        # Tweak initialization, text input (encoder_hidden_states) as None.
        encoder_hidden_states = None if self.cross_attention_dim == 0 else jnp.zeros((1, 1, self.cross_attention_dim), dtype=jnp.float32)
    ...
    def __call__(
        ...
        Args:
            ...
            encoder_hidden_states (`jnp.ndarray`, *optional*)): (batch_size, sequence_length, hidden_size) encoder hidden states
        ...
        sample = jnp.transpose(sample, (0, 3, 1, 2)) # CHW
