# Code credit to https://github.com/GaParmar/img2img-turbo
import random
import numpy as np
...
from src.pipeline_flax_stable_diffusion import FlaxUnconditionalStableDiffusionPipeline

model, params = FlaxUnconditionalStableDiffusionPipeline.from_pretrained("sd-kai")
...
def run(image, prompt, prompt_template, style_name, seed, val_r):
    ...
    print(f"ratio={val_r}, seed={seed}")
    batch_size = 1
    sampling_seed = jax.random.PRNGKey(0)
    num_inference_steps = 50
    num_devices = jax.local_device_count()
    sampling_seed = jax.random.split(sampling_seed, num_devices)
    output_image = model(batch_size, params, sampling_seed, num_inference_steps, jit=True).images
...
with gr.Blocks(css="style.css") as demo:
    ...
    gr.HTML(
        ...
        <div style="display: flex; justify-content: center; align-items: center; text-align: center;">
            <div>
                <h2><a href="https://github.com/EvergreenTree/di-f-fu-sion">Diffusion Models</a></h2>
                <div>
                    <div style="display: flex; justify-content: center; align-items: center; text-align: center;">
                        <a href='https://changqingfu.com/'>Changqing Fu, </a>
                    </div>
                </div>
                </br>
                <div style="display: flex; justify-content: center; align-items: center; text-align: center;">
                    <a href='https://hal.science/hal-04383027'>
                        <img src="https://raw.githubusercontent.com/EvergreenTree/homepage/master/pic/conic.png">
                    </a>
                </div>
            </div>
        </div>
